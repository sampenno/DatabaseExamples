...
con = sqlite3.connect("Question21.db")
cur = con.cursor()
...
with open('Question21.txt','r',encoding='utf-8-sig') as f:
    reader = csv.reader(f, delimiter=',')
    for row in reader:
        print(row)
        try:
            cur.execute("INSERT INTO Issues (JobID, Issue, Response, FixTime, Category, Status) VALUES(?,?,?,?,?,?)", row)
